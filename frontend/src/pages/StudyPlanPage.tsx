                ...
                <div className="relative flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-col gap-3 min-w-[200px]">
                        ...
                        <button
                            ...
                            className="bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-2xl px-6 py-4 text-sm font-bold flex items-center justify-center gap-3 transition-all"
                        >
                            <Plus size={18} />
                            New Study Plan
                        </button>
                        <button
                            ...
                            className="btn-ghost inline-flex items-center justify-center gap-3 text-sm font-bold text-slate-400 hover:text-white"
                        >
                            <ArrowLeft size={16} />
                            Back to dashboard
                        </button>
                                    ...
                                    {[1, 2, 3].map((step) => (
                                        <React.Fragment key={step}>
                                            <div className="flex items-center gap-3">
                                                <div className={`flex h-12 w-12 items-center justify-center rounded-2xl font-black text-sm transition-all duration-500 ${currentStep === step
                                                ...
                                                <div className="hidden lg:block">
                                                    <p className={`text-[10px] font-black uppercase tracking-wider ${currentStep === step ? 'text-blue-600' : 'text-slate-400'
                                                        }`}>
                                                        Phase {step}
                                                    </p>
                                        ...
                                        <div className="grid gap-6">
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex gap-4">
                                                    <input
                                                        type="text"
                                                        className={`flex-1 rounded-2xl border bg-slate-50 px-6 py-4 text-sm font-bold text-slate-900 transition-all focus:bg-white focus:ring-2 focus:ring-blue-500/20 ${titleError ? 'border-rose-200 ring-2 ring-rose-500/10' : 'border-slate-100'
                                                            }`}
                                                ...
                                                {planInput.subjects.length === 0 ? (
                                                    ...
                                                    planInput.subjects.map((sub, idx) => (
                                                        <div key={idx} className="group relative flex items-center gap-4 rounded-3xl bg-white p-4 border border-slate-100 shadow-sm transition-all hover:shadow-md hover:border-slate-200">
                                                            <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl ${sub.difficulty === 'hard' ? 'bg-rose-50 text-rose-600' :
                                    ...
                                    <div className="card p-5 space-y-3">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {plans.map((plan) => (
                                                <div
                                                    key={plan._id}
                                                    className={`w-full rounded-2xl border px-4 py-3 text-left transition hover:border-blue-200 hover:bg-blue-50/50 ${selectedPlan?._id === plan._id ? 'border-blue-300 bg-blue-50' : 'border-slate-100'
                                                        }`}
                                                >
                                                ...
                                                <>
                                                    ...
                                                    <div className="grid grid-cols-3 gap-2 text-center">
                                                        <div className="rounded-xl bg-blue-50 p-2">
                                                            <p className="text-[10px] text-slate-500 uppercase font-black">Days</p>
                                                            <p className="text-sm font-bold text-slate-900">{plan.totalStudyDays}</p>
                                                        </div>
                                                        <div className="rounded-xl bg-emerald-50 p-2">
                                                            <p className="text-[10px] text-slate-500 uppercase font-black">Hours</p>
                                                            <p className="text-sm font-bold text-slate-900">{planHours.toFixed(1)}</p>
                                                        </div>
                                                        <div className="rounded-xl bg-amber-50 p-2">
                                                            <p className="text-[10px] text-slate-500 uppercase font-black">Subjects</p>
                                    ...
                                    <div key={session._id} className="relative group">
                                        ...
                                        <div className="flex items-start gap-10">
                                            ...
                                            <div className="flex-shrink-0 relative z-10">
                                                <div className={`flex h-20 w-20 items-center justify-center rounded-[2rem] shadow-xl transition-all border-4 ${dayProgress === 100
                                                ...
                                                <div className="grid gap-6">
                                                    {session.subjects.map((subject, idx) => {
                                                        ...
                                                        return (
                                                            <div
                                                                key={`${session._id}-${idx}`}
                                                                className={`group relative overflow-hidden rounded-[2rem] border p-8 transition-all ${isComplete
                                                                ...
                                                                <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center">
                                                                    ...
                                                                    <div className="flex-shrink-0 flex lg:flex-col items-center gap-4">
                                                                        <button
                                                                            ...
                                                                            className={`h-12 w-12 rounded-2xl flex items-center justify-center transition-all ${isComplete
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className={`h-12 w-12 rounded-2xl flex items-center justify-center transition-all ${isInProgress
                                                                    ...
                                                                    <div className="lg:w-52 space-y-2">
                                                                        ...
                                                                        <div className="grid grid-cols-3 gap-2">
                                                                            <button
                                                                                ...
                                                                                className={`py-3 rounded-xl text-[11px] font-black uppercase tracking-[0.18em] transition-all ${currentStatus === 'pending'
                                                                            ...
                                                                            <button
                                                                                onClick={() => handleStatusChange(session._id, idx, 'in-progress')}
                                                                                className={`py-3 rounded-xl text-[11px] font-black uppercase tracking-[0.18em] transition-all ${isInProgress
                                                                            ...
                                                                            <button
                                                                                onClick={() => handleStatusChange(session._id, idx, 'completed')}
                                                                                className={`py-3 rounded-xl text-[11px] font-black uppercase tracking-[0.18em] transition-all ${isComplete
