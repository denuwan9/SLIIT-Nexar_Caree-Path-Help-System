...
- Name: ai-features.spec.ts >> Nexar AI Intelligence Features >> Career Simulator - Roadmap Generation
- Location: tests\ai-features.spec.ts:27:5
...
Locator: locator('text=Professional Trajectory')
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 180000ms
  - waiting for locator('text=Professional Trajectory')
  ...
  - main [ref=e56]:
    ...
    - generic [ref=e71]:
      - generic [ref=e73]:
        ...
        - paragraph [ref=e84]: Generate a personalised career roadmap. Our AI benchmarks your profile against global standards to provide hyper-personalised career strategy.
      - generic [ref=e86]:
      ...
      - generic [ref=e115]:
        - generic [ref=e116]:
          - img [ref=e118]
          - generic [ref=e122]:
            - heading "Trajectory Objective" [level=3] [ref=e123]
            - paragraph [ref=e126]: Initialise Professional Simulation
        - generic [ref=e127]:
          - generic [ref=e128]:
            - img [ref=e129]
            - textbox "Target Executive Role (e.g. Senior Machine Learning Engineer)" [ref=e132]: Senior Cloud Architect
          - button "Simulate Trajectory" [disabled] [ref=e133]:
            - img [ref=e134]
